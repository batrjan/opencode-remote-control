...
| `RELAY_WS_PING_INTERVAL_MS`, `RELAY_WS_PONG_GRACE_ROUNDS`, `RELAY_SSE_HEARTBEAT_MS`, `RELAY_SSE_MAX_BUFFER_BYTES`, `RELAY_BRIDGE_RECONNECT_WAIT_MS`, `RELAY_PROMPT_TIMEOUT_MS` | relay | Keep-alive tuning — see the table above. |
